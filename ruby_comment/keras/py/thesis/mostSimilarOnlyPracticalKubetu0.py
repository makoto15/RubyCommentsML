...
for i in range(numberOfTestData):
    ...
    difference = -10
    closestIndex = -10
    for j in range(len(commentIDCopy)):
        if j != deleteIndexNum:
    ...
    print(m)
    print()
    print("the most similar code is")
    print(codeIDCopy[m])
    print()
    print("The most similar comment is")
    print(commentIDCopy[m])
    print()
    print("Answer code is")
    print(testDatasRaw[i])
    print()
    
    
    print("Answer comment is")
    print(testCommentsRaw[i])
    print()
    ...
    mostSimilarCodes.append(codeIDCopy[m])
    mostSimilarComments.append(commentIDCopy[m])
...
with open('/home/u00545/comments/RubyCommentsML/ruby_comment/pickle/code/30dim/MostSimilarOnlyPracticalKubetuNum0.binaryfile', 'wb') as web:
